package com.example.backend.activity.controller;

import com.example.backend.activity.domain.Activity;
import com.example.backend.activity.domain.ActivityType;
import com.example.backend.activity.dto.request.CreateActivityRequest;
import com.example.backend.activity.dto.request.ReorderActivitiesRequest;
import com.example.backend.activity.dto.request.UpdateActivityColorRequest;
import com.example.backend.activity.dto.request.UpdateActivityNameRequest;
import com.example.backend.activity.dto.request.UpdateActivityTypeRequest;
import com.example.backend.activity.repository.ActivityRepository;
